            ...
            [ H.div [ HA.class "article__content" ]
                [ H.div [ HA.class "container" ]
                    ...
                    , H.div [ HA.class "richtext" ]
                        ...
                        , H.p [] [ H.text "Ce projet en cours de développement, co-construit avec les enseignants de collège, des CPE, des AED et des chefs d’établissement,  a pour objectif de valoriser les retours d’expérience et les échanges de pratiques personnalisées, via un produit numérique de type réseau social." ]
                ...
                , H.div [ HA.class "container" ]
                    ...
                    , H.div [ HA.class "richtext" ]
                        ...
                        , H.p [] [ H.text "Vous avez envie d'échanger et de partager des outils, des pratiques, des gestes professionnels avec vos collègues ? Rien de plus simple avec le site Devoirs faits ! Postez une courte vidéo de 1 à 2 mn en format paysage et c'est parti !" ]
                        , H.p []
                ...
                , H.div [ HA.class "container" ]
                    ...
                    , H.div [ HA.class "richtext" ]
                        ...
                        , H.p [] [ H.text "Avec ou sans élève, racontez votre mise en oeuvre du dispositif, décrivez son aménagement, partagez votre organisation avec vos collègues, montrez une séance en groupes...tout est permis ! Regardez les exemples déjà proposés sur le site ! Et... si le sujet a déjà été traité, n'hésitez pas à donner votre propre point de vue ! Nous nous enrichirons mutuellement." ]
                        ]
                    ]
                ]
            , H.div [ HA.class "container" ]
