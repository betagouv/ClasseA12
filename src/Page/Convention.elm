    ...
    , body =
        [ H.div [ HA.class "section section-white" ]
            [ H.div [ HA.class "container" ]
                ...
                , H.ul []
                    [ H.li [] [ H.text "Ce service est un réseau social à base de vidéos de pratiques pédagogiques entre enseignants de classes dédoublées (CP et CE1). Il a pour objectif de faciliter les échanges entre pairs et de mutualiser les pratiques." ]
                    , H.li [] [ H.text "Le site «\u{00A0}Classe à 12\u{00A0}» est un espace commun : tous les usagers et partenaires de Classe à 12 sont à la fois dépositaires et bénéficiaires des ressources et services proposés. C’est  un écosystème apprenant : les acteurs qui gravitent autour de Classe à 12\u{00A0}s’enrichissent mutuellement et nourrissent la plateforme de leurs productions." ]
                    , H.li [] [ H.text "Le site Classe à 12 : propose un cadre neutre d’échanges horizontaux : les échanges se font dans un esprit d’ouverture et de bienveillance entre pairs." ]
                    ]
                , H.p [] [ H.text "Conditions d’utilisation :" ]
                , H.ul []
                ...
                , H.p [] [ H.text "Références juridiques utilisées pour la rédaction de la présente charte :" ]
                , H.ul []
                    [ H.li []
