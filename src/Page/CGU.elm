      ...
      , H.div [ HA.class "main" ]
            [ H.div [ HA.class "section section-white" ]
                [ H.div [ HA.class "container" ]
                    ...
                    , H.ul []
                        [ H.li []
                            [ H.text "Ce service est un réseau social à base de vidéos de pratiques pédagogiques entre enseignants de classes dédoublées (CP et CE1). Il a pour objectif de faciliter les échanges entre pairs et de mutualiste les pratiques." ]
                        , H.li
                            []
                            [ H.text "L’esprit Classe à 12 :  Un espace commun : tous les usagers et partenaires de Classe à 12 sont à la fois dépositaires et bénéficiaires des ressources et services proposés." ]
                        , H.li
                            []
                            [ H.text "L’esprit Classe à 12 : Un écosystème apprenant : les acteurs qui gravitent autour de Classe à 12 s’enrichissent mutuellement et nourrissent la plateforme de leurs productions." ]
                        , H.li
                            []
                    ...
                    , H.ul []
                        ...
                        , H.li
                            []
                            [ H.text "Les vidéos non conformes aux programmes ou à une éthique professionnelle feront l’objet d’une non publication ou dépublication." ]
                        , H.li
                            []
                        ...
                        , H.li
                            []
                            [ H.text "Seuls les personnels de l’éducation nationale peuvent créer un compte utilisateur avec leur adresse mail académique. Seuls les personnes inscrites peuvent publier des vidéos et profiter des fonctionnalités de réseautage." ]
                        , H.li
                            []
