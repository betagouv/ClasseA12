...
$ python 009_videos_freeform_keywords.py --auth "<admin login>:<admin password>" --server "https://<kinto server>/v1/"
...
def main():
    parser = cli_utils.add_parser_options(
        description="Switch from the previous keywords to the new ones for the `videos` collection",
